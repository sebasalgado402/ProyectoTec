...
<body>
    ...
    <div class="container-fluid col-12 mt-2">
        ...
        <button type="submit" class="btn btn-success offset-4 col-4" id="btnGenerarFactura">Generar Factura</button>
        <button type="submit" class="btn btn-success offset-4 col-4" id="btnProcesarCompra" disabled>Procesar compra</button>
